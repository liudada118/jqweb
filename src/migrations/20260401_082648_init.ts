...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_hero_banner_cta_buttons\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_banner_cta_buttons_order_idx\` ON \`pages_blocks_hero_banner_cta_buttons\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_banner_cta_buttons_parent_id_idx\` ON \`pages_blocks_hero_banner_cta_buttons\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_business_cards_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text,
  	...
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_business_cards\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_business_cards_cards_order_idx\` ON \`pages_blocks_business_cards_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_business_cards_cards_parent_id_idx\` ON \`pages_blocks_business_cards_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_business_cards_cards_image_idx\` ON \`pages_blocks_business_cards_cards\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_business_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_business_cards_order_idx\` ON \`pages_blocks_business_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_business_cards_parent_id_idx\` ON \`pages_blocks_business_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_business_cards_path_idx\` ON \`pages_blocks_business_cards\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_news_highlight\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`section_title\` text,
  	\`section_subtitle\` text,
  	\`show_more_link\` text DEFAULT '/posts',
  	\`max_items\` numeric DEFAULT 6,
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_news_highlight_order_idx\` ON \`pages_blocks_news_highlight\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_news_highlight_parent_id_idx\` ON \`pages_blocks_news_highlight\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_news_highlight_path_idx\` ON \`pages_blocks_news_highlight\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_product_showcase_products\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text,
  	...
  	\`link_url\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_product_showcase\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_product_showcase_products_order_idx\` ON \`pages_blocks_product_showcase_products\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_product_showcase_products_parent_id_idx\` ON \`pages_blocks_product_showcase_products\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_product_showcase_products_image_idx\` ON \`pages_blocks_product_showcase_products\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_social_channels_channels\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`platform\` text,
  	...
  	\`url\` text,
  	\`qr_code_id\` integer,
  	FOREIGN KEY (\`qr_code_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_social_channels\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_social_channels_channels_order_idx\` ON \`pages_blocks_social_channels_channels\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_social_channels_channels_parent_id_idx\` ON \`pages_blocks_social_channels_channels\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_social_channels_channels_qr_code_idx\` ON \`pages_blocks_social_channels_channels\` (\`qr_code_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_social_channels\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_social_channels_order_idx\` ON \`pages_blocks_social_channels\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_social_channels_parent_id_idx\` ON \`pages_blocks_social_channels\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_social_channels_path_idx\` ON \`pages_blocks_social_channels\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_rich_content\` (
  	...
  	\`section_subtitle\` text,
  	\`content\` text,
  	\`layout\` text DEFAULT 'fullWidth',
  	\`side_image_id\` integer,
  	\`background_color\` text DEFAULT 'none',
  	\`block_name\` text,
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_rich_content_side_image_idx\` ON \`pages_blocks_rich_content\` (\`side_image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_timeline_events\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`year\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_timeline_events_order_idx\` ON \`pages_blocks_timeline_events\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_timeline_events_parent_id_idx\` ON \`pages_blocks_timeline_events\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_timeline_events_image_idx\` ON \`pages_blocks_timeline_events\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_feature_grid_features_image_idx\` ON \`pages_blocks_feature_grid_features\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_hero_banner_cta_buttons\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`label\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_banner_cta_buttons_order_idx\` ON \`_pages_v_blocks_hero_banner_cta_buttons\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_banner_cta_buttons_parent_id_idx\` ON \`_pages_v_blocks_hero_banner_cta_buttons\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_business_cards_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text,
  	...
  	\`_uuid\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_business_cards\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_business_cards_cards_order_idx\` ON \`_pages_v_blocks_business_cards_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_business_cards_cards_parent_id_idx\` ON \`_pages_v_blocks_business_cards_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_business_cards_cards_image_idx\` ON \`_pages_v_blocks_business_cards_cards\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_business_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_business_cards_order_idx\` ON \`_pages_v_blocks_business_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_business_cards_parent_id_idx\` ON \`_pages_v_blocks_business_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_business_cards_path_idx\` ON \`_pages_v_blocks_business_cards\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_news_highlight\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_news_highlight_order_idx\` ON \`_pages_v_blocks_news_highlight\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_news_highlight_parent_id_idx\` ON \`_pages_v_blocks_news_highlight\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_news_highlight_path_idx\` ON \`_pages_v_blocks_news_highlight\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_product_showcase_products\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`name\` text,
  	...
  	\`_uuid\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_product_showcase\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_product_showcase_products_order_idx\` ON \`_pages_v_blocks_product_showcase_products\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_product_showcase_products_parent_id_idx\` ON \`_pages_v_blocks_product_showcase_products\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_product_showcase_products_image_idx\` ON \`_pages_v_blocks_product_showcase_products\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_social_channels_channels\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`platform\` text,
  	...
  	\`_uuid\` text,
  	FOREIGN KEY (\`qr_code_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_social_channels\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_social_channels_channels_order_idx\` ON \`_pages_v_blocks_social_channels_channels\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_social_channels_channels_parent_id_idx\` ON \`_pages_v_blocks_social_channels_channels\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_social_channels_channels_qr_code_idx\` ON \`_pages_v_blocks_social_channels_channels\` (\`qr_code_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_social_channels\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_social_channels_order_idx\` ON \`_pages_v_blocks_social_channels\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_social_channels_parent_id_idx\` ON \`_pages_v_blocks_social_channels\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_social_channels_path_idx\` ON \`_pages_v_blocks_social_channels\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_rich_content_side_image_idx\` ON \`_pages_v_blocks_rich_content\` (\`side_image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_timeline_events\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`year\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_timeline_events_order_idx\` ON \`_pages_v_blocks_timeline_events\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_timeline_events_parent_id_idx\` ON \`_pages_v_blocks_timeline_events\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_timeline_events_image_idx\` ON \`_pages_v_blocks_timeline_events\` (\`image_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_grid_features_order_idx\` ON \`_pages_v_blocks_feature_grid_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_grid_features_parent_id_idx\` ON \`_pages_v_blocks_feature_grid_features\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_feature_grid_features_image_idx\` ON \`_pages_v_blocks_feature_grid_features\` (\`image_id\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_hero_banner_cta_buttons\`;`)
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_business_cards_cards\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_business_cards\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_news_highlight\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_product_showcase_products\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_product_showcase\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_social_channels_channels\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_social_channels\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_contact_info\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_rich_content\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_timeline_events\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_hero_banner_cta_buttons\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_business_cards_cards\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_business_cards\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_news_highlight\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_product_showcase_products\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_product_showcase\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_social_channels_channels\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_social_channels\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_contact_info\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_rich_content\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_timeline_events\`;`)
